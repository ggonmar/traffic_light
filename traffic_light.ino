...
String getProperHTML(String colorToPut){
  String htmlCode;
  htmlCode =""
"<html>"
...
"   </script>"
"   </head>"
"   <body onload=sendJSCall('"+colorToPut+"')>"
...
void rootPage() {
  ...
  webserver.send(200, "text/html", getProperHTML(semaforoAbierto));
}
...
{
  webserver.send(200,"text/html", "sendJSCall('"+mode+"')");
}
/*
"<script>"
"function sendJSCall(mode)"
